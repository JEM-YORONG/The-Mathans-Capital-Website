        ...
        <div class="container">
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            ...
                            <h3 class="mb-20"><a href="blog-details.php">Cryptocurrency Trading Volatility</a></h3>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            ...
                            <h3 class="mb-20"><a href="blog-details.php">Investments: Bitcoin to Altcoins</a></h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            ...
                            <h3 class="mb-20"><a href="blog-details.php">Trader’s Essential Terms</a></h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            ...
                            <h3 class="mb-20"><a href="blog-details.php">Cryptocurrencies in the Global Economy</a></h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            ...
                            <h3 class="mb-20"><a href="blog-details.php">Every Crypto Trader Knows</a></h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="pagination__area t-center mt-50">
                        <ul>
                            <li><a href="blog-grid.php"><i class="fas fa-chevron-left"></i></a>
                            </li>
                            <li><a href="blog-grid.php">01</a>
                            </li>
                            <li><a class="active" href="blog-grid-2.php">02</a>
                            </li>
                            <li><a href="blog-grid-3.php">03</a>
                            </li>
                            <li><a href="blog-grid-3.php"><i class="fas fa-chevron-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
