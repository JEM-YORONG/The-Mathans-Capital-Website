...
<head>
    <!-- tab title -->
    <title>Blogs | The Mathans Capital (Pvt) Ltd.</title>
        ...
        <div class="container">
          ...
          filter: grayscale(0);">
                            <div class="blog__area-item-image-date"> <span><i class="flaticon-calendar"></i><a
                                        href="#">27 Feb, 2022</a></span>
                            </div>
                        </div>
                        <div class="blog__area-item-content">
                            <div class="blog__area-item-content-meta">
                                <ul>
                                    <li><i class="flaticon-user"></i><a href="#">Mitchell Starc</a></li>
                                    <li><i class="flaticon-chat"></i><a href="#">Comments (3)</a></li>
                                </ul>
                            </div>
                            <h3 class="mb-20"><a href="blog-details.php">Beginner’s Guide to Digital Assets</a></h3>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            <div class="blog__area-item-content-meta">
                                <ul>
                                    <li><i class="flaticon-user"></i><a href="#">Matt Gaetz</a></li>
                                    <li><i class="flaticon-chat"></i><a href="#">Comments (4)</a></li>
                                </ul>
                            </div>
                            <h3 class="mb-20"><a href="blog-details.php">Strategies for Crypto Market Trading</a>
                            </h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            <div class="blog__area-item-content-meta">
                                <ul>
                                    <li><i class="flaticon-user"></i><a href="#">Rudy Giuliani</a></li>
                                    <li><i class="flaticon-chat"></i><a href="#">Comments (2)</a></li>
                                </ul>
                            </div>
                            <h3 class="mb-20"><a href="blog-details.php">Cryptocurrency
                                    Technology</a>
                            </h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            <div class="blog__area-item-content-meta">
                                <ul>
                                    <li><i class="flaticon-user"></i><a href="#">Joe Root</a></li>
                                    <li><i class="flaticon-chat"></i><a href="#">Comments (3)</a></li>
                                </ul>
                            </div>
                            <h3 class="mb-20"><a href="blog-details.php">Investing in Bitcoin: Risks, Rewards</a>
                            </h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            <div class="blog__area-item-content-meta">
                                <ul>
                                    <li><i class="flaticon-user"></i><a href="#">Glenn Max</a></li>
                                    <li><i class="flaticon-chat"></i><a href="#">Comments (4)</a></li>
                                </ul>
                            </div>
                            <h3 class="mb-20"><a href="blog-details.php">Changing the Finance Game</a>
                            </h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
          ...
          filter: grayscale(0);">
                        ...
                        <div class="blog__area-item-content">
                            <div class="blog__area-item-content-meta">
                                <ul>
                                    <li><i class="flaticon-user"></i><a href="#">Aaron Finch</a></li>
                                    <li><i class="flaticon-chat"></i><a href="#">Comments (2)</a></li>
                                </ul>
                            </div>
                            <h3 class="mb-20"><a href="blog-details.php">Investments with Crypto Bots</a>
                            </h3>
                            <div class="blog__area-item-content-btn"> <a href="blog-details.php">Read More <i
                                        class="flaticon-right-arrow"></i></a>
                            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="pagination__area t-center mt-50">
                        <ul>
                            <li><a class="active" href="blog-grid.php">01</a>
                            </li>
                            <li><a href="blog-grid-2.php">02</a>
                            </li>
                            <li><a href="blog-grid-3.php">03</a>
                            </li>
                            <li><a href="blog-grid-2.php"><i class="fas fa-chevron-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
